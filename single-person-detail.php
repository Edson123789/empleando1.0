								...
								<div class="listing-contact-detail-wrap">
									...
									<div class="listing-contact-section-table">
										<div class="listing-contact-table-field">
											<ul>
												<li class="info">Nombre</li>
												<li class="details"><?php  echo $row->Name;?> </li>
											</ul>
										</div>
										<div class="listing-contact-table-field">
											<ul>
												<li class="info">Número de Teléfono</li>
												<li class="details"><?php  echo $row->MobileNumber;?></li>
											</ul>
										</div>
										<div class="listing-contact-table-field">
											<ul>
												<li class="info">Dirección</li>
										...
										<div class="listing-contact-table-field">
											<ul>
												<li class="info">Ciudad</li>
												<li class="details"><?php  echo $row->City;?> </li>
											</ul>
										</div>
										<div class="listing-contact-table-field">
											<ul>
												<li class="info">Correo</li>
												<li class="details"><?php  echo $row->correo;?> </li>
											</ul>
										</div>
						...
						<div class="sidebar sidebar-wrap">
							...
							<div class="sidebar-widget shadow-1">
								<div class="sidebar-widget-title">
									<h5><span class="bgblue-1"></span>Foto de Perfil</h5>
								</div>
