...
$sql="update tblperson set Category=:cat,Name=:name,MobileNumber=:mobilenumber,Address=:address,City=:city,correo=:correo,contrasena=:contrasena where ID=:eid";
...
<head>
  ...
  <title>EMPLEANDO | Actualizar Detalle de Persona</title>
...
<option value="<?php echo htmlentities($row1->Category);?>"><?php echo htmlentities($row1->Category);?></option>
 <?php } ?> 
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="contrasena" name="contrasena" value="<?php echo htmlentities($row->contrasena);?>" required="true">
                  </div> 
                </div>
              <?php $cnt=$cnt+1;}} ?> 
